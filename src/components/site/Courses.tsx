...
const courses = [
  { img: female, title: "Female Quran Teacher", desc: "Learn Quran with proper Tajweed from a qualified female teacher." },
  { img: egyptian, title: "Egyptian Quran Teacher", desc: "Qualified Egyptian Arabic and Quran teachers — experts in Tajweed & recitation." },
  { img: arabic, title: "Arabic Language", desc: "Insight into Arab culture and a deeper understanding of traditions." },
  { img: quran, title: "Quran Reading (Qirat)", desc: "Recite the Quran with proper pronunciation and melodious tone, following Tajweed." },
  { img: hifz, title: "Quran Memorization", desc: "Strengthen your connection by memorizing the Quran with proper Tajweed." },
  { img: kids, title: "Quran Classes for Kids", desc: "Engaging and interactive lessons in a fun, supportive environment." },
  { img: tafseer, title: "Learn Tafseer Quran", desc: "Understand deeper meanings, context, and divine guidance." },
  { img: tajweed, title: "Learn Quran with Tajweed", desc: "Perfect your recitation with proper pronunciation and rules." },
];
  ...
  <section className="py-24 bg-gradient-parchment">
    <div className="container">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {courses.map((c) => (
          <article key={c.title} className="ornate-card group">
