      ...
      <div className="container grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/80">
            ...
            <li><button onClick={() => openModal()} className="hover:text-gold transition-colors text-left">Free Trial</button></li>
            <li><a href="#" className="hover:text-gold transition-colors">About Us</a></li>
            <li><a href="#" className="hover:text-gold transition-colors">Become a Tutor</a></li>
